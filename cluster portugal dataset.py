...
def drawTop(win):
    l1 = Line(Point(50, 550), Point(50, 50)) # set endpoints
    l1.setWidth(2)
    l1.draw(win)
    l1 = Line(Point(50, 50), Point(800, 50)) # set endpoints
    l1.setWidth(2)
    l1.draw(win)


    tt2 = Text(Point(30,150),'5')
    tt2.setSize(12)
    tt2.setTextColor("blue")
    tt2.draw(win)

    tt2 = Text(Point(30,250),'10')
    tt2.setSize(12)
    tt2.setTextColor("blue")
    tt2.draw(win)

    tt2 = Text(Point(30,350),'15')
    tt2.setSize(12)
    tt2.setTextColor("blue")
    tt2.draw(win)

    tt2 = Text(Point(30,450),'20')
    tt2.setSize(12)
    tt2.setTextColor("blue")
    tt2.draw(win)
...
def main():
    win = GraphWin('Student results',1000,600)
    ...
    tt = Text(Point(500,580), "Data Analysis")
    tt.setSize(14)
    tt.setTextColor("red")
    tt.draw(win)

    l1 = Line(Point(1, 550), Point(999, 550)) # set endpoints
    l1.setWidth(3)
    l1.draw(win)

    rect = Rectangle(Point(850, 500), Point(1000, 530))
    rect.setFill("Green")
    rect.draw(win)
    tt = Text(Point(925,515), "Draw Graph")
    tt.setSize(14)
    tt.setTextColor("Black")
    tt.draw(win) # Button to trigger the save text option
    #----------------------------------

    rect = Rectangle(Point(900, 460), Point(950, 490))
    rect.setFill("blue")
    rect.draw(win)
    tt = Text(Point(925,475), "Exit")
    tt.setSize(14)
    tt.setTextColor("red")
    tt.draw(win) # Button to trigger the EXIT option
    ...
    while exitnow == False:
         ...
         if xx >= 900 and xx <= 950 and yy <= 490 and yy >= 460:
            exitnow = True # exit loop

         if xx >= 850 and xx <= 1000 and yy <= 530 and yy >= 500:
            drawTop(win)


            topic = "mock exams vs final grade"

            tt = Text(Point(150,35), "5")
            tt.setSize(14)
            tt.setTextColor("Black")
            tt.draw(win) # Button to trigger the save text option

            tt = Text(Point(250,35), "10")
            tt.setSize(14)
            tt.setTextColor("Black")
            tt.draw(win) # Button to trigger the save text option

            tt = Text(Point(350,35), "15")
            tt.setSize(14)
            tt.setTextColor("Black")
            tt.draw(win) # Button to trigger the save text option

            tt = Text(Point(450,35), "20")
            tt.setSize(14)
            tt.setTextColor("Black")
            tt.draw(win) # Button to trigger the save text option

            tt = Text(Point(250,500), "Mock score 0-20")
            tt.setSize(14)
            tt.setTextColor("Black")
            tt.draw(win) 
            
            tt = Text(Point(550,25), "Final score 0-20")
            tt.setSize(14)
            tt.setTextColor("Black")
            tt.draw(win)

            tt = Text(Point(600,400), "Tutor hired")
            tt.setSize(14)
            tt.setTextColor("Black")
            tt.draw(win)

            l1 = Line(Point(50, 50), Point(450, 450)) # set endpoints
            l1.setWidth(1)
            l1.setFill("black")
            l1.draw(win)
            #--------------------------------------------------------------
            # Print d32 and d33 coordinates to cluster
            for c in range(640):
                n = random.randint(0,3)
                y = (d32[c] * 20)+ 50
                x = (d33[c] * 20) + 50
                l1 = Line(Point(x + n, y + n), Point(x + 2 + n, y + 2 + n)) # set endpoints
                l1.setWidth(2)
                if (d18[c]) == 'no':
                    l1.setFill("red")
                else:
            ...
            #-----------------------------------------------------------------
            # display results as scatter plots
            # Top graph
