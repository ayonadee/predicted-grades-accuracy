...
def main():
    ...
    male = 0
    female = 0
    age17 = 0 #count students up to 17
    age18 = 0 #count students over 18 - 22
    le3 = 0
    gt3 = 0
    ...
    for c in range(totalStudents):
        ...
        yesno = d19[c] # search for this data
        
        if yesno == "yes" and d33[c] > 9:
            yesPassed += 1
        if yesno == "yes" and d33[c] < 10:
            yesFailed += 1
        if yesno == "no" and d33[c] > 9:
            noPassed += 1
        if yesno == "no" and d33[c] < 10:
            noFailed += 1
    ...
    print("age15to17 =" + str(age17))
    print("age18to22 =" + str(age18))
    print("children in the house less than 3 =" + str(le3))
    print("children in the house more than 3 =" + str(gt3))
