...
def main():
    ...
    for c in range(600):
        ...
        mockprobability = d32[c]/20
        if periodonescore < mockprobability and d33[c] <= d31[c]:
            loweraspredicted += 1
            answercorrect = True
        ...
        elif periodonescore < mockprobability and d33[c] > d31[c]:
        ...
        #print ('P = ' + str(periodonescore))

        predictedscore = periodonescore * 20
        d35[c] = predictedscore
        d34[c] = periodonescore
        print ('compare ' + str(d33[c]) + ' ' + str(int(d35[c])))
        if answercorrect == True:
            correctdifferences += abs(d33[c] - d35[c]) #difference between mock results and final results
            maximumcorrect += 1
        totaldifferences += abs(d33[c] - d35[c])
    ...
    print('average difference = ' + str(totaldifferences/600)) #average differences for all
    print('average difference amongst correct answers = ' + str(correctdifferences/maximumcorrect))
