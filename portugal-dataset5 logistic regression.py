...
def main():
    ...
    for c in range(totalStudents):
        ...
        if int(d14[c]) == 1 and int(d33[c]) > 9: #10-20 is the past mark
            yesPassed1 += 1
        if int(d14[c]) == 2 and int(d33[c]) > 9: #10-20 is the past mark
            yesPassed2 += 1
        if int(d14[c]) == 3 and int(d33[c]) > 9: #10-20 is the past mark
            yesPassed3 += 1
        if int(d14[c]) == 4 and int(d33[c]) > 9: #10-20 is the past mark
            yesPassed4 += 1
        if int(d14[c]) == 1 and int(d33[c]) < 10: #10-20 is the past mark
            yesFailed1 += 1
        if int(d14[c]) == 2 and int(d33[c]) < 10: #10-20 is the past mark
            yesFailed2 += 1
        if int(d14[c]) == 3 and int(d33[c]) < 10: #10-20 is the past mark
            yesFailed3 += 1
        if int(d14[c]) == 4 and int(d33[c]) < 10: #10-20 is the past mark
            yesFailed4 += 1
...
#data check to analysie the fairness of the data
    ...
    print("weeklystudytime log plot")
